...
export default function App() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col relative">
      {showToast && (
        <div className="fixed top-24 left-1/2 transform -translate-x-1/2 z-[60] bg-gray-900 text-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-3">
      ...
      <header className="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
          ...
          <button onClick={() => setShowAddModal(true)} className="hidden md:flex bg-gray-900 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-gray-800 transition-all shadow-md items-center gap-2">
